...
cardDetalle.innerHTML = `<div class="row g-0 justify-content-md-center my-4">
...
<div class="col-sm-12 col-md-4">
    <div class="card-body">
    <h5 class="card-title fw-bolder">${productoEncontrado.nombre}</h5>
    <p class="card-text">
        <ul>
        ...
        <div class="mx-3">
          <a href="error.html" class="mt-2"><i class="bi bi-cart-plus fs-2 mx-3"></i></a>
        </div>
    </p>
    </div>
</div>
